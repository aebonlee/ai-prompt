      ...
      <div className="container nav-wrapper">
        ...
        <div className="nav-actions">
          ...
          <button className="theme-toggle" data-mode={mode} onClick={cycleMode} title="테마 전환">
            ...
            <svg className="auto-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2v20M2 12h20"/></svg>
          </button>
