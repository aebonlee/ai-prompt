...
export default function AiTipsHome() {
  return (
    <>
      <SEOHead title="AI활용 Tip!" description="AI 도구를 효과적으로 활용하는 방법을 배워봅시다." />

      <section className="page-header">
        <div className="container">
          <h1>AI활용 Tip!</h1>
          <p>AI 도구를 효과적으로 활용하는 방법을 배워봅시다</p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="curriculum-grid" style={{ gridTemplateColumns: 'repeat(4, 1fr)' }}>
            {byType.map((item) => (
              <Link to={item.path} key={item.path} className="curriculum-card">
