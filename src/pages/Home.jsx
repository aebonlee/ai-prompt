...
const curriculum = [
  { step: 'STEP 01', icon: '💡', title: '프롬프트 엔지니어링이란?', desc: '프롬프트의 개념과 AI 모델과의 대화 원리를 이해합니다.', path: '/intro/what-is-prompt', topics: 'Prompt · AI · LLM' },
  { step: 'STEP 02', icon: '🤖', title: 'AI 모델 이해하기', desc: 'ChatGPT, Claude, Gemini 등 주요 AI 모델의 특징을 비교합니다.', path: '/intro/ai-models', topics: 'ChatGPT · Claude · Gemini' },
  { step: 'STEP 03', icon: '🏗️', title: '프롬프트 구조와 패턴', desc: '효과적인 프롬프트의 구조와 핵심 패턴을 학습합니다.', path: '/learn/structure', topics: '구조 · 패턴 · 템플릿' },
  { step: 'STEP 04', icon: '🎯', title: 'Few-shot 기법', desc: '예시를 활용하여 AI의 응답 품질을 높이는 기법을 배웁니다.', path: '/learn/few-shot', topics: 'Zero-shot · Few-shot · Example' },
  { step: 'STEP 05', icon: '🧠', title: 'Chain-of-Thought', desc: 'AI가 단계별로 사고하도록 유도하는 고급 기법을 학습합니다.', path: '/learn/chain-of-thought', topics: 'CoT · 추론 · 단계별' },
  { step: 'STEP 06', icon: '🎭', title: '역할 부여와 시스템 프롬프트', desc: 'AI에게 역할을 부여하고 시스템 프롬프트를 설계합니다.', path: '/learn/role-system', topics: 'Role · System · Persona' },
  { step: 'STEP 07', icon: '✍️', title: '실전: 글쓰기', desc: '블로그, 이메일, 보고서 등 글쓰기에 프롬프트를 활용합니다.', path: '/practice/writing', topics: '블로그 · 이메일 · 보고서' },
...
const features = [
  { icon: '🎯', title: '실습 중심 학습', desc: '매 챕터마다 직접 프롬프트를 작성하고 결과를 비교하며 학습합니다.' },
  { icon: '🔄', title: '다양한 AI 모델 대응', desc: 'ChatGPT, Claude, Gemini 등 여러 AI 모델에 적용 가능한 범용 기법을 다룹니다.' },
  { icon: '📋', title: '업무 활용 템플릿', desc: '실무에서 바로 사용할 수 있는 프롬프트 템플릿을 제공합니다.' }
]

const targets = [
  { icon: '👨‍💼', title: 'AI 활용 입문자', desc: 'AI를 처음 접하거나 더 잘 활용하고 싶은 분' },
  { icon: '👩‍💻', title: '개발자', desc: 'AI를 코딩 보조 도구로 활용하고 싶은 개발자' },
  { icon: '📝', title: '콘텐츠 크리에이터', desc: 'AI로 콘텐츠 생산성을 높이고 싶은 분' }
]
