    ...
    return (
      <section className="section">
        <div className="container">
          <div className="lecture-empty">강의안을 찾을 수 없습니다.</div>
          ...
          <div className="lecture-detail">
            ...
            {lecture.file_url && (
              <div className="lecture-file-section">
                {user ? (
                  <a
                    href={lecture.file_url.startsWith('http') ? lecture.file_url : `${import.meta.env.BASE_URL}${lecture.file_url.replace(/^\//, '')}`}
                    target="_blank"
            ...
            <div className="lecture-detail-actions">
              ...
              {isOwner && (
                <>
                  <Link to={`/lectures/edit/${id}`} className="lecture-action-btn primary">
                    수정
                  </Link>
